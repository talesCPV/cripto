...
//			echo $word."<br> -> {$size}<br>ch1: {$ch1}<br>ch2: {$ch2}<br>st1: {$st1}<br>st2: {$st2}<br>soma: {$soma}<br>23: {$word[23]} ". ord($word[23]) ." <br>36: {$word[36]} ".ord($word[36]) ;
...
//		echo "<br> -> {$size}<br>ch1: {$ch1}<br>ch2: {$ch2}<br>st1: {$st1}<br>st2: {$st2}<br>{$word}<br>23: {$str[23]} ". ord($str[23]) ."<br>36: {$str[36]} ".ord($str[36]);
